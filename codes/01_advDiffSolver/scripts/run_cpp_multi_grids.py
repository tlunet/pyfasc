"""
Run C++ implementation with 256x256, 128x128 and 64x64 grids.
"""
...
def main():
    ...
    for grid_size in [256, 128, 64]:
        ...
        # Move results
        shutil.move(base_dir / "uInit.txt", results_dir / f"uInit_cpp_{grid_size}x{grid_size}.txt")
        shutil.move(base_dir / "uEnd.txt", results_dir / f"uEnd_cpp_{grid_size}x{grid_size}.txt")
